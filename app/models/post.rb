class Post < ApplicationRecord
	...
	# Post.contriues('asia') => [Array of countries in that region]
	def self.countries(continent)
		...
		@array_of_countries = []
		data_hash[:countries].each do |country|
			if country[:continent] == continent
				@array_of_countries << country[:name]
			end
		end
